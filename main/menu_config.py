        ...
        ('检中管理',
         {
             ...
             'state': True,
             'childs': OrderedDict([
             # ('体检预约',{'pid': 300, 'id': 3001, 'title': '体检预约', 'tip': None, 'state': True, 'icon':'预约','is_tool':True,'shortcut':None}),
             # ('体检登记',{'pid': 300, 'id': 3002, 'title': '体检登记', 'tip': None, 'state': True, 'icon':'登记','is_tool':True,'shortcut':None}),
             # ('体检收费',{'pid': 300, 'id': 3003, 'title': '体检收费', 'tip': None, 'state': True, 'icon':'收费','is_tool':True,'shortcut':None}),
             # ('临床检查',{'pid': 300, 'id': 3004, 'title': '临床检查', 'tip': None, 'state': True, 'icon':'录入','is_tool':True,'shortcut':None}),
             # ('医生总检',{'pid': 300, 'id': 3005, 'title': '医生总检', 'tip': None, 'state': True, 'icon':'预约','is_tool':True,'shortcut':None}),
...
SYS_MENU_MODULE_CLASS = {
    ...
    4004: {'module': None, 'class': None, 'enabled': False},
